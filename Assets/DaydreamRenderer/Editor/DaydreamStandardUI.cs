...
public class DaydreamStandardUI : ShaderGUI
{
    static private class Styles
    {
        ...
        static public GUIContent m_linearLightingGC = new GUIContent("Linear Space Lighting", "Enable Linear Space Lighting");
    };
    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        toggleFeature("LINEAR_LIGHTING", Styles.m_linearLightingGC, targetMats);
